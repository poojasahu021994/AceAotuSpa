...
<section class="checkout-page">
                            ...
                            <div class="col-xl-12">
                                <div class="billing_details_form-btns">
                                    <div class="billing_details_form-btn-1">
                                        <button type="submit" class="thm-btn">Continue Shopping <span><i
                                                    class="icon-next"></i></span>
                                        </button>
                                    </div>
                                    <div class="billing_details_form-btn-2">
                                        <button type="submit" class="thm-btn">Return To Cart <span><i
                                                    class="icon-next"></i></span>
                                        </button>
                                    </div>
                                </div>
    ...
    <a class="thm-btn" href="#" onclick="showPopup(event)">Place your order 
...
<div id="paymentPopup" class="popup-overlay">
    <div class="popup-box">
        ...
        <p class="popup-message">
            Thank you for choosing Ace Auto Spa.
        </p>
