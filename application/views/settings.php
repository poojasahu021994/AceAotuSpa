                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="dashboard__main-content">
                            ...
                            <div class="dashboard__content">
                                <div class="dashboard__my-settings-content-box">
                                    <h3 class="dashboard__my-booking-title">Settings</h3>
                                    <form class="dashboard__my-settings-box">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="dashboard__my-settings-input-box">
                                                    <p>Full Name</p>
                                                    <input type="text" name="name" placeholder="Jonaton Jonson">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="dashboard__my-settings-input-box">
                                                    <p>Email</p>
                                                    <input type="email" name="email" placeholder="jonaton@example.com">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="dashboard__my-settings-input-box">
                                            ...
                                            <div class="col-md-12">
                                                <div class="dashboard__my-settings-btns-box">
                                                    <button type="reset"
                                                        class="dashboard__my-settings-btn-1">Reset</button>
                                                    <button type="button" class="dashboard__my-settings-btn-2">Save
                                                        Changes</button>
                                                </div>
                                            </div>
                                        </div>
