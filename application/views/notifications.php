                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="dashboard__main-content">
                            ...
                            <div class="dashboard__content">
                                <div class="dashboard__my-notifications-content-box">
                                    <h3 class="dashboard__my-booking-title">Notifications</h3>
                                            ...
                                            <table class="table align-middle common-table-box">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>10 Sep 2025</td>
                                                        <td>
                                                            <span class="dashboard__completed-style">Active</span>
                                                        </td>
                                                        <td>
                                                            <button
                                                                class="dashboard__my-notifications-btn-1">View</button>
                                                            <button
                                                                class="dashboard__my-notifications-btn-2">Delete</button>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>02</td>
                                                        <td>Payment pending for invoice #1234</td>
                                                        <td>09 Sep 2025</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>03</td>
                                                        <td>Login attempt from new device</td>
                                                        <td>08 Sep 2025</td>
                                                        <td>
